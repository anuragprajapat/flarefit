...
<module external.linked.project.id=":react-native-facebook-account-kit" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  <component name="FacetManager">
    <facet type="android-gradle" name="Android-Gradle">
      <configuration>
        <option name="GRADLE_PROJECT_PATH" value=":react-native-facebook-account-kit" />
      </configuration>
    </facet>
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7" inherit-compiler-output="false">
    ...
    <content url="file://$MODULE_DIR$">
      ...
      <excludeFolder url="file://$MODULE_DIR$/build/intermediates/exploded-aar/com.facebook.android/account-kit-sdk/4.23.0/jars" />
    ...
    <orderEntry type="library" exported="" name="account-kit-sdk-4.23.0" level="project" />
    ...
    <orderEntry type="library" exported="" name="react-native-0.50.4" level="project" />
